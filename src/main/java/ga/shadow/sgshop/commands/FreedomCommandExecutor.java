...
public class FreedomCommandExecutor<C extends AeroCommandBase<?>> extends AbstractCommandExecutor<C> {
    ...
    public FreedomCommandExecutor(Main plugin, AeroCommandHandler<?> handler, String name, C command) {
    ...
    public void setupCommand(PluginCommand pluginCommand) {
        ...
        if (perms != null) {
            if (perms.level().isConsole()) {
                Main.plugin().getLogger().warning("[Command] " + pluginCommand.getName() + " - permission is set to a console rank, "
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            Main.plugin().getLogger().severe("Unhandled command exception: " + command.getName());
    ...
    public static class FreedomExecutorFactory implements AeroCommandExecutorFactory {
        ...
        public FreedomExecutorFactory(Main plugin) {
            this.plugin = plugin;
        }
